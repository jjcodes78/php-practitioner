...
<section class="todoapp">
    ...
    <footer class="footer">
        ...
        <ul class="filters">
            <li>
                <a href="/"
                    <?php if(! in_array(App\Facades\Request::queryString('filter'), ['active', 'completed'])) echo 'class="selected"'?>>
                    All
                </a>
            </li>
            <li>
                <a href="/?filter=active"
                    <?php if(App\Facades\Request::queryString('filter') == 'active') echo 'class="selected"'?>>
                    Active
                </a>
            </li>
            <li>
                <a href="/?filter=completed"
                    <?php if(App\Facades\Request::queryString('filter') == 'completed') echo 'class="selected"'?>>
                    Completed
                </a>
            </li>
        </ul>
